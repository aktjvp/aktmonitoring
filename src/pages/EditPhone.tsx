...
import { CalendarIcon, Save, X, Phone, ArrowLeft } from "lucide-react";
...
export default function EditPhone() {
  ...
  const onSubmit = (data: z.infer<typeof phoneSchema>) => {
    console.log(data);
    toast({
      title: "Telefon ma'lumotlari yangilandi",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Telefon ma'lumotlarini tahrirlash</h1>
          <p className="text-muted-foreground">
            Telefon ma'lumotlarini yangilang
          </p>
        </div>
      </div>
